...
namespace DemoNew.Controllers
{
    ...
    {
        // GET: EmployeeReports
        public ActionResult DailyWorkReports()
        {
            #region ddlProject
        ...
        [HttpPost]
        [ActionName("DailyWorkReports")]
        [OnAction(ButtonName = "Search")]
        public ActionResult GetDailyWorkReports(Employee model)
        {
            ...
            model.FK_EmployeeID = Session["PK_EmployeeID"].ToString();
